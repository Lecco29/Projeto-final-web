...
export default function FaultyTerminal({
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (!gl) {
        console.warn('WebGL não está disponível, usando fallback');
        return;
      }
    } catch (e) {
      console.warn('Erro ao verificar WebGL:', e);
      return;
    }
    ...
    try {
      ...
      console.error('Erro ao inicializar renderer:', e);
      return;
    }
    ...
    return () => {
      ...
      try {
        ...
        console.warn('Erro ao perder contexto WebGL:', e);
      }
